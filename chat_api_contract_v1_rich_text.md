    ...
    "payload": {
      ...
      "properties": {
        ...
        "sequenceNumber": {
          "type": "integer",
          "minimum": 1,
          "description": "1-based position of this message within the response sequence for a single user turn. A single user message may produce multiple bot messages (e.g., a text preamble followed by a property carousel). Required when sender.type = bot."
        },
