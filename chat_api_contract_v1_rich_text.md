...
> - `html` messageType has been **removed** — use `markdown` for rich text responses.
...
- **One primary enum**: `messageType`: `context | text | template | user_action | markdown | analytics`
